...
START_DATE = datetime(2022, 3, 22, tzinfo=timezone.utc)
...
async def fetch_channel_messages(client, channel_name, keywords, start_date, end_date, total_messages=None, filename='Russia-Ukraine/Russia/Politicians/Medvedev/medvedev.csv'):
    all_messages = []
...
def save_to_csv(messages, filename='Russia-Ukraine/Russia/Politicians/Medvedev/medvedev.csv', write_header=False):
