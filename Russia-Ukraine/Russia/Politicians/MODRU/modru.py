...
CHANNEL_NAME = '@mod_russia'
START_DATE = datetime(2022, 3, 12, tzinfo=timezone.utc)
END_DATE = datetime(2025, 2, 25, tzinfo=pytz.timezone('Europe/Kiev'))
KEYWORDS = [
    'Россия', 'Москва', 'Кремль', 'Донбасс', 'Донецк', 'Луганск', 'Путин', 'Медведев', 'Лавров', 'Белоусов',
    'Шойгу', 'Патрушев', 'Герасимов', 'Пригожин', 'Группа Вагнера', 'Крым', 'Севастополь',
    'Украина', 'Киев', 'Зеленский', 'Азов', 'Хохлы', 'Нацисты', 'ЕС', 'НАТО', 'ФСБ', 'ГРУ', 'СВР', 'ДНР', 'ЛНР',
    'Калибр', 'Искандер', 'С-400', 'Герань', 'Ланцет', 'Шахед', 'МиГ', 'Су', 'Т-90', 'Армата', 'Запад', 'Восток',
    'Херсон', 'Запорожье', 'Покровск', 'Бахмут', 'Белгород', 'Курск', 'Ростов'
]
...
async def fetch_channel_messages(client, channel_name, keywords, start_date, end_date, total_messages=None, filename='Russia-Ukraine/Russia/Politicians/MODRU/modru.csv'):
    all_messages = []
...
def save_to_csv(messages, filename='Russia-Ukraine/Russia/Politicians/MODRU/modru.csv', write_header=False):
