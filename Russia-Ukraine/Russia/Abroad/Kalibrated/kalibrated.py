...
CHANNEL_NAME = '@kalibrated'
START_DATE = datetime(2023, 4, 21, tzinfo=timezone.utc)
...
KEYWORDS =  [
    ...
    'Shoigu', 'Patrushev', 'Gerasimov', 'Prigozhin', 'Wagner Group', 'Crimea', 'Sevastopol',
    'Ukraine', 'Kiev', 'Zelensky', 'Azov', 'Hohols', 'Nazis', 'EU', 'NATO', 'FSB', 'GRU', 'SVR', 'DNR', 'LNR',
    'Kalibr', 'Iskander', 'S-400', 'Geran', 'Lancet', 'Shahed', 'MiG', 'Su', 'T-90', 'Armata', 'Zapad', 'Vostok', 
    'Kherson', 'Zaporizhzhia', 'Pokrovsk', 'Bakhmut', 'Belgorod', 'Kursk', 'Rostov'
]
...
async def fetch_channel_messages(client, channel_name, keywords, start_date, end_date, total_messages=None, filename='Russia-Ukraine/Russia/Abroad/Kalibrated/kalibrated.csv'):
    all_messages = []
...
def save_to_csv(messages, filename='Russia-Ukraine/Russia/Abroad/Kalibrated/kalibrated.csv', write_header=False):
