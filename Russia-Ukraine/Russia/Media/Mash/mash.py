...
async def fetch_channel_messages(client, channel_name, keywords, start_date, end_date, total_messages=None, filename='Russia-Ukraine/Russia/Media/Mash/mash.csv'):
    all_messages = []
...
def save_to_csv(messages, filename='Russia-Ukraine/Russia/Media/Mash/mash.csv', write_header=False):
