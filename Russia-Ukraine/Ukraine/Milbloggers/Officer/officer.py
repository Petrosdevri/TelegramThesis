...
CHANNEL_NAME = '@officer_alex33'
START_DATE = datetime(2023, 7, 18, tzinfo=timezone.utc)
...
async def fetch_channel_messages(client, channel_name, keywords, start_date, end_date, total_messages=None, filename='Russia-Ukraine/Ukraine/Milbloggers/Officer/officer.csv'):
    all_messages = []
...
def save_to_csv(messages, filename='Russia-Ukraine/Ukraine/Milbloggers/Officer/officer.csv', write_header=False):
