...
CHANNEL_NAME = '@petrenko_iHS'
START_DATE = datetime(2023, 9, 11, tzinfo=timezone.utc)
...
async def fetch_channel_messages(client, channel_name, keywords, start_date, end_date, total_messages=None, filename='Russia-Ukraine/Ukraine/Milbloggers/Petrenko/petrenko.csv'):
    all_messages = []
...
def save_to_csv(messages, filename='Russia-Ukraine/Ukraine/Milbloggers/Petrenko/petrenko.csv', write_header=False):
