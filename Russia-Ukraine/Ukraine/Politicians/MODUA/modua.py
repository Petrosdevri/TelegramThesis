...
CHANNEL_NAME = '@ministry_of_defense_ua'
START_DATE = datetime(2022, 3, 9, tzinfo=timezone.utc)
...
async def fetch_channel_messages(client, channel_name, keywords, start_date, end_date, total_messages=None, filename='Russia-Ukraine/Ukraine/Politicians/MODUA/modua.csv'):
    all_messages = []
...
def save_to_csv(messages, filename='Russia-Ukraine/Ukraine/Politicians/MODUA/modua.csv', write_header=False):
