...
CHANNEL_NAME = '@ermaka2022'
START_DATE = datetime(2022, 3, 16, tzinfo=timezone.utc)
...
async def fetch_channel_messages(client, channel_name, keywords, start_date, end_date, total_messages=None, filename='Russia-Ukraine/Ukraine/Politicians/Yermak/yermak.csv'):
    all_messages = []
...
def save_to_csv(messages, filename='Russia-Ukraine/Ukraine/Politicians/Yermak/yermak.csv', write_header=False):
