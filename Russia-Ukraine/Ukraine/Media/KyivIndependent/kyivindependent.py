...
CHANNEL_NAME = '@KyivIndependent_official'
START_DATE = datetime(2022, 2, 24, tzinfo=timezone.utc)
END_DATE = datetime(2025, 2, 25, tzinfo=pytz.timezone('Europe/Kiev'))
KEYWORDS = [
    'Ukraine', 'Kyiv', 'Zelensky', 'UAF', 'Donbas', 'Donetsk', 'Luhansk', 'Reznikov', 'Zaluzhnyi', 'Budanov', 'Poroshenko', 
    'Crimea', 'Sevastopol', 'Azov', 'Azovstal', 'Mariupol', 'Irpin', 'Bucha', 'Kharkiv', 'Kherson', 'Mykolaiv', 'Odesa', 
    'Dnipro', 'Lviv', 'Chernihiv', 'Sumy', 'Zaporizhzhia', 'Bakhmut', 'Avdiivka', 'Kramatorsk', 'Sloviansk',
    'Russia', 'Moscow', 'Putin', 'Orcs', 'Rashists', 'Vatniks', 'NATO', 'EU', 'HUR', 'SBU', 'Bayraktar', 'Javelin', 
    'HIMARS', 'Stugna', 'Neptune', 'Patriot', 'Drone', 'Leopard', 'Challenger', 'Abrams', 'Bradley', 'F-16', 'Maidan'
]
...
async def fetch_channel_messages(client, channel_name, keywords, start_date, end_date, total_messages=None, filename='Russia-Ukraine/Ukraine/Media/KyivIndependent/kyivindependent.csv'):
    all_messages = []
...
def save_to_csv(messages, filename='Russia-Ukraine/Ukraine/Media/KyivIndependent/kyivindependent.csv', write_header=False):
