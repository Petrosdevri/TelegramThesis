...
CHANNEL_NAME = '@ElamAlmoqawama'
START_DATE = datetime(2023, 10, 7, tzinfo=timezone.utc)
END_DATE = datetime(2025, 2, 25, tzinfo=pytz.timezone('Asia/Gaza'))
KEYWORDS = [
    'فلسطين', 'غزة', 'الضفة الغربية', 'حماس', 'فتح', 'الجهاد الإسلامي', 'الجبهة الشعبية', 'القسام',
    'لبنان', 'حزب الله', 'المقاومة الإسلامية', 'اليمن', 'أنصار الله', 'الحوثي', 'العراق', 'الحشد الشعبي',
    'إيران', 'الحرس الثوري', 'اسرائيل', 'جيش الإحتلال', 'الصهيونية', 'الاحتلال', 'المقاومة', 'نصر الله', 'هنية', 'السنوار',
    'رفح', 'إيرز', 'رام الله', 'جنين', 'نابلس', 'الخليل', 'أريحا', 'بيت لحم', 'بيروت', 'صنعاء', 'القدس', 'تل ابيب'
]
...
async def fetch_channel_messages(client, channel_name, keywords, start_date, end_date, total_messages=None, filename='Israel-Palestine/Palestine/Organisations/ElamAlMoqawama/elamalmoqawama.csv'):
    all_messages = []
...
def save_to_csv(messages, filename='Israel-Palestine/Palestine/Organisations/ElamAlMoqawama/elamalmoqawama.csv', write_header=False):
