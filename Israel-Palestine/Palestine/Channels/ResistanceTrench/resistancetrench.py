...
CHANNEL_NAME = '@ResistanceTrench2'
START_DATE = datetime(2023, 10, 24, tzinfo=timezone.utc)
END_DATE = datetime(2025, 2, 25, tzinfo=pytz.timezone('Asia/Gaza'))
KEYWORDS = [
    'Palestine', 'Gaza', 'West Bank', 'Hamas', 'Fatah', 'PIJ', 'PFLP', 'Al Qassam Brigades',
    'Lebanon', 'Hezbollah', 'Islamic Resistance', 'Yemen', 'Ansarullah', 'Houthi', 'Iraq', 'PMF', 
    'Iran', 'IRGC', 'Israel', 'IDF', 'Zionism', 'Occupation', 'Resistance', 'Nasrallah', 'Haniyeh', 'Sinwar',
    'Rafah', 'Erez', 'Ramallah', 'Jenin', 'Nablus', 'Hebron', 'Jericho', 'Bethlehem', 'Beirut', "Sana'a", 'Jerusalem', 'Tel Aviv'
]
...
async def fetch_channel_messages(client, channel_name, keywords, start_date, end_date, total_messages=None, filename='Israel-Palestine/Palestine/Channels/ResistanceTrench/resistancetrench.csv'):
    all_messages = []
...
def save_to_csv(messages, filename='Israel-Palestine/Palestine/Channels/ResistanceTrench/resistancetrench.csv', write_header=False):
