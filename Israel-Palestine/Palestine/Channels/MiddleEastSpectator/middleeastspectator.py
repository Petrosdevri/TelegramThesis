...
CHANNEL_NAME = '@Middle_East_Spectator'
...
KEYWORDS = [
    ...
    'Iran', 'IRGC', 'Israel', 'IDF', 'Zionism', 'Occupation', 'Resistance', 'Nasrallah', 'Haniyeh', 'Sinwar', 'Khamenei',
...
async def fetch_channel_messages(client, channel_name, keywords, start_date, end_date, total_messages=None, filename='Israel-Palestine/Palestine/Channels/MiddleEastSpectator/middleeastspectator.csv'):
    all_messages = []
...
def save_to_csv(messages, filename='Israel-Palestine/Palestine/Channels/MiddleEastSpectator/middleeastspectator.csv', write_header=False):
