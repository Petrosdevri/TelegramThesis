...
CHANNEL_NAME = '@PoliticsGR'
START_DATE = datetime(2024, 5, 4, tzinfo=timezone.utc)
...
async def fetch_channel_messages(client, channel_name, keywords, start_date, end_date, total_messages=None, filename='Israel-Palestine/Palestine/Channels/PoliticsGR/politicsgr.csv'):
    all_messages = []
...
def save_to_csv(messages, filename='Israel-Palestine/Palestine/Channels/PoliticsGR/politicsgr.csv', write_header=False):
