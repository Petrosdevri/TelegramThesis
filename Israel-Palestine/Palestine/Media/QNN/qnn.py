...
async def fetch_channel_messages(client, channel_name, keywords, start_date, end_date, total_messages=None, filename='Israel-Palestine/Palestine/Media/QNN/qnn.csv'):
    all_messages = []
...
def save_to_csv(messages, filename='Israel-Palestine/Palestine/Media/QNN/qnn.csv', write_header=False):
