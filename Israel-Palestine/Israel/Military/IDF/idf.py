...
CHANNEL_NAME = '@idfofficial'
START_DATE = datetime(2023, 10, 7, tzinfo=timezone.utc)
END_DATE = datetime(2025, 2, 25, tzinfo=pytz.timezone('Asia/Gaza'))
KEYWORDS = [
    'Israel', 'IDF', 'Mossad', 'Shin Bet', 'Iron Dome', 'Knesset', 'Netanyahu', 'Gallant', 'Katz', 
    "Sa'ar", 'Ben Gvir', 'Smotrich', 'Tel Aviv', 'Jerusalem', 'Haifa', 'Ashkelon', 'Ashdod', 'Gaza', 'Judea', 
    'Beer Sheva', 'Eilat', 'Galilee', 'Negev', 'Dimona', 'Kiryat Shmona', 'Metulla', 'Shlomi', 'Sderot'
]
...
async def fetch_channel_messages(client, channel_name, keywords, start_date, end_date, total_messages=None, filename='Israel-Palestine/Israel/Military/IDF/idf.csv'):
    all_messages = []
...
def save_to_csv(messages, filename='Israel-Palestine/Israel/Military/IDF/idf.csv', write_header=False):
